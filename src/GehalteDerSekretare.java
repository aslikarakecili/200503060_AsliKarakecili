...
public class GehalteDerSekretare extends javax.swing.JFrame {
    ...
    public void tableDetails(){
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from sekretargehalt where SekretarID='"+SekretarID+"'");
            while (rs.next()){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            ResultSet rs1 = st.executeQuery("select * from sekretargehalt inner join sekretar where sekretargehalt.Monat='"+Monat+"' and sekretargehalt.SekretarID='"+SekretarID+"' and sekretar.SekretarID='"+SekretarID+"'");
            while(rs1.next()){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("insert into sekretargehalt values(?,?,?)");
