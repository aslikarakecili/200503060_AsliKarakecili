 ...
 * @author lenovo
 */
public class SekretarTrainerMaasOdeme extends javax.swing.JFrame {

    /**
     * Creates new form SekretarTrainerMaasOdeme
     */
    public SekretarTrainerMaasOdeme() {
        initComponents();
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update trainer set Gehalt=?,Genommen=? where TrainerID=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SekretarTrainerMaasOdeme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
