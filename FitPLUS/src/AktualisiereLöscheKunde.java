...
public class AktualisiereLöscheKunde extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update kunde set Ausweis=?,Vorname=?,Nachname=?,Age=?,Lange=?,Gewicht=?,Telefonnummer=?,Sportprogramm=?,Rechnung=? where KundenID=?");
